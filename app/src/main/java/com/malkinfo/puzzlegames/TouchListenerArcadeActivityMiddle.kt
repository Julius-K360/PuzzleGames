...
/**
 * Diese Klasse ist verantwortlich für die Logik hinter dem Touchen,
 * also für die Ineraktion mit den Puzzleteilen
 */
class TouchListenerArcadeActivityMiddle(private val activity: ArcadeActivityMiddle) : OnTouchListener {
    ...
    override fun onTouch(view: View, motionEvent: MotionEvent): Boolean {
        ...
        piece.setOnClickListener(){
            ...
            val p_rotate = AnimationUtils.loadAnimation(
                activity,
                R.anim.piece_rotate
            )

            piece.startAnimation(p_rotate)
