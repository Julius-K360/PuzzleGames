 ...
 *
 */
class ArcadeActivityHard : AppCompatActivity() {
    //Variablen
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageView.post {
            ...
            pieces = splitImage()
            val touchListener = TouchListenerArcadeActivityHard(this@ArcadeActivityHard)
    ...
    fun startTimeCounter(view: View) {
        ...
        object : CountDownTimer(aktuellerCounterWert.toLong()*1000, 1000) {  //CounterWert w8ird mal 1000 gerechnet damit wir Sekunden haben
            ...
            override fun onFinish() {
                ...
                var helper = DatabaseHandler(this@ArcadeActivityHard)
                ...
                AlertDialog.Builder(this@ArcadeActivityHard) // Baut den Dialog der am ende Angezeigt wird
                    ...
                    .setPositiveButton("Hauptmenü"){
                            dialog, _->
                        val intent = Intent(this@ArcadeActivityHard,MainMenu::class.java)  //Button leitet einen zurück zum Mainmenü
