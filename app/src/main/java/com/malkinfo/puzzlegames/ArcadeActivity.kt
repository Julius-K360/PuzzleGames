...
//Variablen
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageView.post {
            ...
            pieces = splitImage()
            val touchListener = TouchListenerArcadeActivity(this@ArcadeActivity)
    ...
    fun startTimeCounter(view: View) {
        ...
        object : CountDownTimer(aktuellerCounterWert.toLong()*1000, 1000) {  //CounterWert w8ird mal 1000 gerechnet damit wir Sekunden haben
            ...
            override fun onFinish() {
                ...
                var helper = DatabaseHandler(this@ArcadeActivity)
                ...
                AlertDialog.Builder(this@ArcadeActivity) // Baut den Dialog der am ende Angezeigt wird
                    ...
                    .setPositiveButton("Hauptmenü"){
                            dialog, _->
                        val intent = Intent(this@ArcadeActivity,MainMenu::class.java)  //Button leitet einen zurück zum Mainmenü
